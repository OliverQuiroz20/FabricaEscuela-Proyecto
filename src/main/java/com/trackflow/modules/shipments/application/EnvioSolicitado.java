 ...
 *
 * Lleva la ciudad de destino ya resuelta, y no solo su identificador, para que quien
 * consuma el mensaje pueda construir la etiqueta que ve el cliente sin volver a
